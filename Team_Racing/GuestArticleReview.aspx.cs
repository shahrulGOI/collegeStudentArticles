...
{
    public partial class GuestArticleReview : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    iframe.Src = "~/Files/" + database.getStudent_Username() + "/" + System.Convert.ToString(table.Rows[0][0])+ "#toolbar=0";
